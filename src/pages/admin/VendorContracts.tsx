...
export function VendorContracts() {
  ...
  const getContractTypeLabel = (type: string) => {
    switch (type) {
      case 'vendor_terms':
        return 'Vendor Terms & Conditions';
      case 'vendor_privacy':
        return 'Vendor Privacy Policy';
      default:
        return type;
    }
  };
      ...
      <div className="mb-8">
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h1 className={`text-3xl font-bold ${textPrimary}`}>Vendor Contracts</h1>
              <p className={textSecondary}>Manage vendor terms and conditions and privacy policy</p>
            </div>
          </div>
