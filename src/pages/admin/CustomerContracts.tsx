...
import { FileText, Edit, Eye, Save, X, AlertCircle, Clock, Check, List, Grid } from 'lucide-react';
  ...
  const getContractTypeLabel = (type: string) => {
    switch (type) {
      ...
      case 'customer_privacy':
        return 'Customer Privacy Policy';
      default:
        return type;
    }
  };
      ...
      <div className="mb-8">
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h1 className={`text-3xl font-bold ${textPrimary}`}>Customer Contracts</h1>
              <p className={textSecondary}>Manage customer terms and conditions and privacy policy</p>
            </div>
          </div>
              ...
              <div className="space-y-4 mb-6">
                <div>
                  ...
                  <input
                    ...
                    disabled
                    className={`w-full px-4 py-2 border ${borderColor} rounded-lg bg-gray-100 dark:bg-gray-700 ${textSecondary}`}
                  />
                </div>
