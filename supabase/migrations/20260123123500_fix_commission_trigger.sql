/*
  # Fix Commission Trigger for POS Orders
  
  1. Updates `handle_order_settlement` to support INSERT operations.
  2. Updates `trg_order_settlement` to fire on both INSERT and UPDATE.
  
  This ensures that orders created directly with 'paid' status (like POS orders) trigger commission calculations.
*/
...
-- Update trigger to include INSERT
